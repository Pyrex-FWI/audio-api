...
class Media extends \AudioCoreEntity\Entity\Media {
	...
	static public $providerMapCodeToId = [
	...
	static public $providerMapIdToClass = [
		...
		self::PROVIDER_MEDIA => Media::class,
	];
	...
	public static function getProviderEntityClass($providerId) {
		if (isset(Media::$providerMapIdToClass[$providerId])) {
			return Media::$providerMapIdToClass[$providerId];
		}
	}
	...
	public static function getProviderClass($provider) {
		$key = Media::$providerMapIdToClass[$provider];
		return $key;
	}
